...
$sorgu_yayinevi = mysqli_query($baglanti, "SELECT yayineviID, yayineviAdi FROM yayınevleri");
?>
...
<main class="flex-shrink-0">
    <div class="container">
        ...
        <p class="lead">Bu sayfada aşağıda yer alan formu kullanarak veritabanına yeni bir eser ekleyebilirsiniz!
        </p>
...
<form method="post" action="eser_ekle2.php">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="formControl2" name="eserYayinYili">
    </div>
    <div class="mb-3">
        <label for="formControl3" class="form-label">Eser Türü</label>
        <input type="text" class="form-control" id="formControl3" name="eserTürü">
    </div>
    <div class="mb-3">
