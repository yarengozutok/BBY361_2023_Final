<?php
    ...
    $sorgu = mysqli_query($baglanti, "SELECT ES.*, YA.yayineviAdi, CONCAT( YZ.yazarAdi,' ', YZ.yazarSoyadi) AS YZAdSoyad FROM eserler ES, yayınevleri YA, yazarlar YZ WHERE ES.yayineviID = YA.yayineviID AND ES.yazarID = YZ.yazarID AND (ES.eserAdi LIKE('%$q%') OR YZ.yazarAdi LIKE('%$q%') OR YZ.yazarSoyadi LIKE('%$q%') OR YA.yayineviAdi LIKE('%$q%'))");
